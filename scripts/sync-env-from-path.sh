...
export VITE_PULSE_AUCTION=$PULSE
export VITE_PATH_ADAPTER=$ADAPTER
export VITE_PATH_MINTER=$MINTER
export VITE_PATH_NFT=$NFT
EOF

cat "$OUT"
echo "Wrote to $OUT, pls source it to environment if needed."
