...
async function readThoughtFromLog(
  ...
  return {
    ...
    agent: metadataString(properties.agent) || provenance.agent,
    model: metadataString(properties.model) || provenance.model,
    agentHash: metadataString(properties.agentKeccak256),
    modelHash: metadataString(properties.modelKeccak256),
