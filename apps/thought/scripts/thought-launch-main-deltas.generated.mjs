export const CURRENT_THOUGHT_LAUNCH_MAIN_DELTAS = Object.freeze([
  Object.freeze([
    "Agent chooser warning tone",
    '      tone: "neutral",\n      eventId: `work-agent-selection:${hashText(state.prompt)}`,',
    '      tone: "warning",\n      eventId: `work-agent-selection:${hashText(state.prompt)}`,',
  ]),
  Object.freeze([
    "Claude launch warning tone",
  ...
  Object.freeze([
    "Claude Code folderless launch guidance",
  ...
  Object.freeze(["launch state delta 51", "      detail: \"Choose an Agent available on this machine to receive the prompt.\",", "      detail: 'Choose an installed Agent. For Claude Code, use a fresh chat with \"No folder\": this artwork task needs no repository access.',"]),
