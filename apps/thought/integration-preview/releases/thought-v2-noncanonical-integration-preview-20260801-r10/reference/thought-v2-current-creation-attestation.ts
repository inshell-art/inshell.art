...
export const THOUGHT_CREATION_ATTESTATION_PROFILE =
  "inshell.thought.creation-workflow-attestation.v2" as const;
...
export const CREATION_ATTESTATION_DOMAIN_VERSION = "2" as const;
export const CREATION_ATTESTATION_PRIMARY_TYPE = "CreationAttestation" as const;
export const CREATION_ATTESTATION_TYPE_STRING =
  "CreationAttestation(bytes32 profileId,address thoughtNft,bytes32 protocolReleaseId,bytes32 thoughtSpecId,bytes32 thoughtSpecHash,bytes32 workHash,bytes32 provenanceHash,bytes32 agentHash,bytes32 modelHash,bytes32 runIdHash,address intendedMinter,uint64 deadline,uint32 authorityEpoch)" as const;
