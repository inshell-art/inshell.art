...
const formatPulseAuctionDecimal = (
  value: string,
...
export const formatPulseAuctionPrice = (
  price: bigint,
  decimals = 18,
  significantFractionDigits = 8,
): string =>
...
export const pulseAuctionPriceAtTimestamp = (input: {
  floorPrice: bigint;
  curveK: bigint;
  ...
  return input.floorPrice + input.curveK / (effectiveTime - input.anchorTimeSec);
};
