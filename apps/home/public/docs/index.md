...
- [WILL](https://inshell.art/docs/will) — WILL is Inshell's developing crowd movement: many people, many Agents, one will.
...
THOUGHT is current and has a live creation and mint flow. WILL is planned for 2027 and is still being created and developed; its preview can expose the direction and current study without implying a finished work or live mint. AWA is planned for 2028 and remains in formation; it currently has no creation or mint surface.
...
- **PulseAuction · Settle · Public issuance** — Live ask · one serial epoch
- **PathPulseAdapter · Issue · Public issuance** — Valid settlement → PATH issuance
- **PathNFT · Record PATH · Public issuance** — Issued PATH · order · capacity
- **ThoughtNFT · Validate work · Later THOUGHT mint** — THOUGHT work · PATH permission
- **PathNFT · Consume unit · Later THOUGHT mint** — Caller · owner · stage · quota
- **ThoughtNFT · Mint + record · Later THOUGHT mint** — Atomic with PATH consumption
...
- **THOUGHT · Agent return** — Candidate produced
- **THOUGHT · Human review** — Decision to preserve
- **THOUGHT · Successful mint** — Contract action succeeds
- **THOUGHT · Public corpus** — Preserved THOUGHT
- **PULSE · Visible ask** — Quote exposed
- **PULSE · Confirmed bid** — Participant authorizes
- **PULSE · Settlement** — Contract action succeeds
- **PULSE · Sale record** — Preserved Pulse
