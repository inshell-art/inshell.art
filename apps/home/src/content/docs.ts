  ...
  topics: [
    {
      ...
      figure: {
        ...
        items: [
          { title: "Shell", detail: "Real and often necessary." },
          { title: "Surface", detail: "Visible · operable · legible." },
          { title: "Boundary", detail: "Not the whole being." },
        ...
        },
        {
          ...
          figure: {
            ...
            items: [
              ...
              {
                title: "Relation",
                detail: "Approaches without claiming possession",
              },
              {
                title: "Practice",
              ...
              {
                title: "Boundary",
                detail: "Does not prove or guarantee freedom",
              },
            ],
          },
          paragraphs: [
    ...
    },
    {
      ...
      sections: [
        ...
        {
          id: "docs-agent-art-thought",
          title: "THOUGHT is one practice",
          paragraphs: [
      ...
      links: [{ label: "read THOUGHT as one practice ↗", href: "/docs/thought" }],
    },
    {
      slug: "movements",
      id: "docs-movements",
      ...
      figure: {
        label: "Why the movements form a PATH",
        mode: "trace",
        figureText: [
          "INSHELL PRACTICE",
        ...
        items: [
          {
            title: "THOUGHT",
            detail: "Current: inspect how an Agent responds to one person's thought.",
          },
          {
            title: "WILL",
            detail:
              "In development: many people and many Agents form one will.",
          },
          {
            title: "AWA",
            detail:
              "Forming: toward Inshell's core; its form is still taking shape.",
          },
        ],
      },
      sections: [
        {
          ...
          figure: {
            label: "Agent participation across the movements",
            mode: "ledger",
            figureText: [
            ...
            items: [
              {
                title: "THOUGHT",
                detail: "Individual · one person + one Agent response.",
              },
              {
                title: "WILL",
                detail: "Crowd · many people and Agents; still developing.",
              },
              {
                title: "AWA",
                detail: "Toward the core · still forming.",
              },
              { title: "ALL", detail: "An Agent participates." },
            ],
          },
          paragraphs: [
    ...
    },
    {
      ...
      sections: [
        {
          ...
          figure: {
            label: "The ordered-pair boundary",
            mode: "field",
            figureText: [
            ...
            items: [
              {
                title: "Ordered-pair boundary",
                detail: "Human prompt P + Agent response R → (P, R)",
              },
              {
                title: "Different response",
                detail: "(P, R′) = different work",
              },
              {
              ...
              {
                title: "Preservation",
                detail: "Candidate → successful mint → onchain THOUGHT",
              },
            ],
          },
          paragraphs: [
        ...
        },
        {
          ...
          figure: {
            label: "From intention to minted THOUGHT",
            mode: "lanes",
            figureText: [
            ...
            items: [
              {
                ...
                lane: "Human",
                title: "Prompt",
                detail: "Enter one exact Terminal English line.",
              },
              {
                stage: 2,
                lane: "Agent",
                title: "Response",
                detail: "Return one exact line; no repair dialogue.",
              },
              {
                stage: 3,
                lane: "App",
                title: "Validate + assemble",
                detail: "Check exact bytes; assemble the preview and creation record.",
              },
              {
                stage: 4,
                lane: "Human",
                title: "Review + choose",
                detail:
                  "Read the candidate and decide whether to preserve it; select a PATH.",
              },
              {
                stage: 5,
                lane: "Wallet",
                title: "Authorize + submit",
                detail: "Sign the narrow permission, then confirm the mint transaction.",
              },
              {
                stage: 6,
                lane: "Contracts",
                ...
                detail:
                  "Enforce rules, consume one PATH unit, mint, and expose the record.",
              },
            ],
          },
          paragraphs: [
        ...
        },
        {
          ...
          figure: {
            label: "Creation Attestation bindings",
            mode: "field",
            figureText: [
              "RECORDED VALUES",
            ...
            items: [
              {
                ...
                detail:
                  "Human line · Agent line · selected Agent · runtime-reported model when available · specification · renderer context · mint anchors",
              },
              {
                title: "App claim",
              ...
              },
              {
                title: "Claim ceiling",
                detail:
                  "Does not prove hidden reasoning · provider identity · sole authorship.",
              },
            ],
          },
          paragraphs: [
      ...
      links: [
        ...
        { label: "view the THOUGHT gallery state ↗", href: "/gallery" },
    ...
    },
    {
      ...
      figure: {
        ...
        items: [
          { title: "Scope", detail: "Many people · many Agents" },
          { title: "Inquiry", detail: "Crowd behavior" },
          {
            title: "Direction",
            detail: "How a crowd forms what can be called one will.",
          },
          { title: "Form", detail: "Still in development." },
          {
            title: "Boundary",
            detail:
              "One will should not yet be read as consensus, unanimity, voting, or governance.",
          },
        ],
      },
      sections: [
    ...
    },
    {
      ...
      figure: {
        ...
        items: [
          { title: "Direction", detail: "Toward Inshell's core." },
          {
            title: "Agent Art invariant",
            detail: "An Agent participates.",
          },
          { title: "Form", detail: "Still forming." },
          {
            title: "Boundary",
            detail:
              "AWA does not claim the core is reached, defined, revealed, or proved.",
          },
        ],
      },
      sections: [
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          figure: {
            label: "Deployment quota and one PATH's progress",
            mode: "ledger",
            figureText: [
              "SCOPE      │ STATE",
              "───────────┼────────────────────────────────────────────",
            ...
            items: [
              {
                title: "Deployment",
                detail: "Quota + authorized minter per movement.",
              },
              {
                title: "One PATH",
                detail: "Current stage + in-stage minted count.",
              },
              {
                title: "Derived",
                detail: "Remaining = quota - this PATH's minted count.",
              },
              {
                title: "Advance",
                detail: "Quota reached → next movement + count reset.",
              },
              {
                title: "Absent",
                detail: "No configured quota → not available.",
              },
            ],
          },
          paragraphs: [
            ...
            items: [
              {
                title: "Read",
                detail:
                  "Read the current owner, stage, quota, minter, permission epoch, and owner nonce.",
              },
              {
                title: "Authorize",
                detail:
                  "The current owner signs one short-lived EIP-191 authorization; signing alone consumes nothing.",
              },
              {
                title: "Submit",
                detail:
                  "The movement mint transaction calls the configured minter, which calls PathNFT.",
              },
              {
                title: "Verify + consume",
                detail:
                  "PathNFT checks the caller and current-owner authorization, then confirms the movement order and that quota remains.",
              },
              {
                title: "Commit + refresh",
                detail:
                  "A successful movement mint commits one unit and the work together; events expose progress.",
              },
            ],
          },
          paragraphs: [
      ...
      sections: [
        {
          ...
          figure: {
            ...
            items: [
              {
                title: "Ask",
                detail: "The current epoch exposes one live onchain price.",
              },
              {
                title: "Wait",
                detail: "The ask decays toward its floor while the epoch remains open.",
              },
              {
                title: "Bid",
                detail:
                  "A successful bid settles at the sampled ask and issues the next PATH.",
              },
              {
                title: "Pump",
                detail: "Elapsed time becomes the initial premium for the next epoch.",
              },
              {
                title: "Repeat",
                detail: "The sale joins the public history and a new descent begins.",
              },
            ],
          },
          paragraphs: [
        ...
        },
        {
          ...
          figure: {
            label: "When the live ask settles",
            mode: "trace",
            figureText: [
              "01 Read live ask",
            ...
            items: [
              {
                title: "Read live ask",
                detail: "Read the current ask from contract-backed state.",
              },
              {
                title: "Set maximum",
                detail: "Review the maximum charge before the wallet opens.",
              },
              {
                title: "Submit",
                detail: "Submit the bid with that maximum as its ceiling.",
              },
              {
                title: "Settle or revert",
                detail:
                  "Execution reads again: ask ≤ maximum → exact ask settles, surplus refunds, and PATH issues; ask > maximum → transaction reverts; read again.",
              },
            ],
          },
          steps: [
            ...
            items: [
              {
                ...
                title: "Settle",
                detail: "Calculate the live ask and settle one serial epoch.",
              },
              {
                stage: 2,
                ...
                phase: "Public issuance",
                title: "Issue",
                detail: "Translate the valid settlement into PATH issuance.",
              },
              {
                stage: 3,
                lane: "PathNFT",
                phase: "Public issuance",
                title: "Record PATH",
                detail: "Own the issued PATH, its movement order, and its capacity.",
              },
              {
                stage: 4,
                lane: "ThoughtNFT",
                ...
                title: "Validate work",
                detail: "Validate the THOUGHT work and request PATH permission use.",
              },
              {
                stage: 5,
                lane: "PathNFT",
                phase: "Later THOUGHT mint",
                title: "Consume permission",
                detail:
                  "Verify configured caller, current-owner authorization, active stage, and quota; advance one unit.",
              },
              {
                stage: 6,
                lane: "ThoughtNFT",
                ...
                title: "Mint + record",
                detail:
                  "Mint and record the work; a later revert also reverts PATH consumption.",
              },
            ],
          },
          paragraphs: [
    ...
    },
    {
      ...
      figure: {
        label: "Evidence for one token interpretation",
        mode: "ledger",
        figureText: [
          "RECORD         │ EVIDENCE",
          "───────────────┼────────────────────────────────",
        ...
        items: [
          { title: "Identity", detail: "Network, contract address, and token ID name one NFT." },
          { title: "Contract", detail: "Typed state and tokenURI expose contract-controlled facts." },
          { title: "Release", detail: "Pinned artifacts explain the ABI, renderer, schemas, and commitments." },
          { title: "Context", detail: "Detail pages and provenance add declared evidence without replacing the token." },
          { title: "Interpretation", detail: "Read the evidence levels together before making a larger claim." },
        ],
      },
      sections: [
        {
    ...
    },
    {
      ...
      figure: {
        ...
        items: [
          { title: "Explore", detail: "Compare distinct native-path systems as a visual field." },
          { title: "Refine", detail: "Tune one complete repertoire for rhythm, clarity, and identity." },
          { title: "Seal", detail: "Freeze the paths, metrics, order, package, and integrity hashes." },
          { title: "Pin", detail: "Bind a renderer release to the exact Mono 76 artifact it consumes." },
          { title: "Render", detail: "Generate native SVG without browser font lookup or substitution." },
        ],
      },
      sections: [
        {
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          figure: {
            label: "Evidence levels and their bounded sources",
            mode: "ledger",
            figureText: [
            ...
            items: [
              {
                ...
                detail: "Deployed rule accepted defined values.",
              },
              {
                title: "Contract-release",
                detail: "Pinned expected artifacts.",
              },
              {
                title: "Chain-observed",
                detail: "Named network + observation point.",
              },
              {
                title: "App-recorded",
                detail: "App assembled or signed the record.",
              },
              {
                title: "Runtime-reported",
                detail: "Agent runtime or connector supplied it.",
              },
              {
                title: "Artist-editorial",
                detail: "Meaning, practice, or interpretation.",
              },
            ],
          },
          points: [
        ...
        },
        {
          ...
          figure: {
            label: "A chain-first verification pass",
            mode: "trace",
            figureText: [
              "01 Locate",
            ...
            items: [
              {
                title: "Locate",
                detail: "Record the network, contract address, token ID, and transaction.",
              },
              {
                title: "Read",
                detail:
                  "Query typed contract state and tokenURI from the identified deployment.",
              },
              {
                title: "Pin",
                detail:
                  "Match the deployment to its release, ABI, renderer, schemas, and checksums.",
              },
              {
                title: "Recompute",
                detail: "Validate published hashes, work commitments, and specification rules.",
              },
              {
                title: "Qualify",
                detail:
                  "State exactly what each proof establishes and what remains reported or editorial.",
              },
            ],
          },
          steps: [
    ...
    },
    {
      ...
      figure: {
        label: "Trust boundaries for wallet and local actions",
        mode: "ledger",
        figureText: [
        ...
        items: [
          {
            title: "Read",
            detail: "App / public state. No signature or transaction.",
          },
          {
            title: "Connect",
            detail:
              "Wallet → App. Exposes the selected account and network; no chain change.",
          },
          {
            title: "Sign",
            detail:
              "Wallet message. Narrow authorization; no gas and no chain change by itself.",
          },
          {
            title: "Transact",
            detail:
              "Wallet → contract. Wallet confirms; may transfer value or change chain state.",
          },
          {
            title: "Save / Load",
            detail: "Current browser. Local only; not onchain or cross-device.",
          },
          {
            title: "Agent run",
            detail:
              "App backend. Temporary run-window state; not onchain unless a later public record preserves part.",
          },
        ],
      },
      sections: [
    ...
    },
    {
      ...
      figure: {
        label: "Records that identify live behavior",
        mode: "ledger",
        figureText: [
          "RECORD      │ BOUNDARY",
          "────────────┼────────────────────────────────────",
        ...
        items: [
          { title: "Source", detail: "A repository shows authored code and ongoing development." },
          { title: "Release", detail: "A pinned artifact set freezes code, schemas, renderers, and checksums." },
          { title: "Deployment", detail: "A network record binds a release to addresses and deployment blocks." },
          { title: "Observation", detail: "A live read reports what that deployment exposes at a point in time." },
        ],
      },
      sections: [
        {
          ...
          figure: {
            ...
            items: [
              ...
              },
              {
                ...
                detail:
                  "Contract action succeeds; before success, no preserved public record.",
              },
              {
                stage: 4,
                lane: "THOUGHT",
                title: "Public corpus",
                detail: "Preserved THOUGHT record.",
              },
              {
                stage: 1,
                lane: "PULSE",
                title: "Visible ask",
                detail: "Quote is visible.",
              },
              {
                stage: 2,
                lane: "PULSE",
        ...
        },
        {
          ...
          figure: {
            ...
            items: [
              {
                title: "Origin",
                detail: "Network + contract + token ID + tokenURI + release",
              },
              {
                title: "Reading surfaces",
                detail: "Site · wallet · marketplace · API · Markdown · Agent answer",
              },
              {
                title: "Relation",
                detail: "Surfaces add access and context.",
              },
              {
                title: "Boundary",
                detail: "They do not replace the record's origin.",
              },
            ],
          },
          paragraphs: [
...
> = {
  ...
  "agent-art": {
    ...
    sections: {
      ...
      "docs-agent-art-thought": ["artist-editorial"],
    },
  },
  movements: {
    lead: ["artist-editorial"],
