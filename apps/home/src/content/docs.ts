...
export const DOCS_SOURCE: DocsSource = {
  ...
  topics: [
    ...
    },
    {
      ...
      paragraphs: [
        [
          "Loading a page or opening the shell wallet menu does not initialize WalletConnect or query an account or network. Account access begins only after a visitor selects Connect and chooses a wallet. After connection, the explicit Refresh action can update the cached account, network, and ",
          { label: "$PATH", href: "/docs/path" },
          " inventory.",
        ],
        [
