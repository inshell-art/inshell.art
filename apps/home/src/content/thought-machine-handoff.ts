...
export const THOUGHT_MACHINE_HANDOFF_SOURCE = {
  ...
  artifacts: [
    ...
    {
      id: "agent-protocol-consumer-lock",
      title: "THOUGHT Agent protocol consumer lock",
      source: "app",
      sourcePath: "packages/thought-agent-protocol/thought-v2.consumer-lock.json",
      publicPath: "app/agent/thought-v2.consumer-lock.json",
      role: "agent-transport-consumer-binding-to-current-v2-release",
      owner: "THOUGHT App",
      authority: "app-record",
      mediaType: "application/json",
    },
    {
      ...
      title: "THOUGHT Agent Creative Brief v2",
      source: "app",
      sourcePath: "apps/thought/spec/THOUGHT.agent-creative.v2.md",
      publicPath: "app/agent/THOUGHT.agent-creative.v2.md",
      role: "agent-creative-response-brief",
      owner: "THOUGHT App",
      authority: "app-documentation",
      mediaType: "text/markdown; charset=utf-8",
    },
    {
      id: "agent-creative-brief-lock",
      title: "THOUGHT Agent Creative Brief lock",
      source: "app",
      sourcePath: "apps/thought/spec/THOUGHT.agent-creative.v2.lock.json",
      publicPath: "app/agent/THOUGHT.agent-creative.v2.lock.json",
      role: "agent-creative-brief-exact-byte-lock",
      owner: "THOUGHT App",
      authority: "app-record",
      mediaType: "application/json",
    },
    ...
    {
      id: "agent-declaration-schema",
      title: "THOUGHT Agent declaration schema",
      source: "contract-release",
      sourcePath: "protocol/current/v2/agent/thought.agent-declaration.v1.schema.json",
      publicPath: "contract/protocol/agent/thought.agent-declaration.v1.schema.json",
      role: "agent-declaration-contract-release-schema",
      owner: "THOUGHT Contract",
      authority: "contract-release",
      mediaType: "application/schema+json",
    },
    {
      ...
      title: "THOUGHT V2 specification architecture",
      source: "contract-release",
      sourcePath: "protocol/current/v2/SPECIFICATION_ARCHITECTURE.md",
      publicPath: "contract/protocol/SPECIFICATION_ARCHITECTURE.md",
      role: "contract-release-specification-ownership-and-dependency-map",
      owner: "THOUGHT Contract",
      authority: "contract-release",
      mediaType: "text/markdown; charset=utf-8",
    },
    {
      id: "path-nft-v0.5-integration",
      title: "PATH NFT v0.5 integration commitment",
      source: "contract-release",
      sourcePath: "protocol/current/v2/integration/path-nft.v0.5.0.json",
      publicPath: "contract/protocol/integration/path-nft.v0.5.0.json",
      role: "path-v0.5-contract-integration-commitment",
      owner: "THOUGHT Contract and PATH Contract",
      authority: "contract-release",
      mediaType: "application/json",
    },
    {
