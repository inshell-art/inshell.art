...
export const DOCS_SOURCE_REGISTRY = {
  ...
  groups: [
    ...
    {
      id: "documentation-gates",
      title: "Documentation gates",
      owner: "inshell.art repository automation",
    ...
    },
    {
      ...
      directories: ["packages/inshell-shell/src"],
      exclude: [/\.test\.[cm]?[jt]sx?$/, /\.spec\.[cm]?[jt]sx?$/, /\.d\.ts$/],
    },
    {
      id: "shared-runtime",
      ...
      files: ["packages/thought-agent-protocol/thought-v2.consumer-lock.json"],
      directories: [
    ...
    },
    {
      ...
      files: [
        ...
        "apps/thought/production/deployment-lock.schema.json",
        "apps/thought/production/activation-policy.json",
        "apps/thought/production/README.md",
        "docs/DEPLOYMENT_LOCK_RUNBOOK.md",
        "scripts/deployment-lock-evidence.ts",
    ...
    },
    {
      ...
      directories: [
        "apps/thought/contract-release/releases/thought-v2-canonical-portable-release-20260807-r2",
      ],
    },
